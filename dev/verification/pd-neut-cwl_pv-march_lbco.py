...
#
# Cross-engine check of the **two-parameter** March-Dollase
# preferred-orientation correction. FullProf applies the standard model
# (its `.out` reports "March-Dollase model for preferred orientation") with
...
# overall offset before fitting). After refining the scale, the patterns agree.
