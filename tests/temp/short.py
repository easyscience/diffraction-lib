...
from easydiffraction.core.objects import Descriptor, Parameter, CategoryItem, CategoryCollection
...
# TODO: Cast int to float for Parameter?
def test_parameter_invalid_int_type_warning():
    cell = Cell()
    with pytest.warns(UserWarning, match="Allowed:"):
        cell.length_a = 5
