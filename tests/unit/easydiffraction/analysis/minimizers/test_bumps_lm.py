...
def test_module_import():
    import easydiffraction.analysis.minimizers.bumps_lm as MUT

    assert MUT.__name__ == 'easydiffraction.analysis.minimizers.bumps_lm'
...
def test_is_subclass_of_bumps():
    ...
    assert issubclass(BumpsLmMinimizer, BumpsMinimizer)
...
def test_default_name():
    ...
    m = BumpsLmMinimizer()
    assert m.name == MinimizerTypeEnum.BUMPS_LM
