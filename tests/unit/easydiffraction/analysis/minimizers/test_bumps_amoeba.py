...
def test_module_import():
    import easydiffraction.analysis.minimizers.bumps_amoeba as MUT

    assert MUT.__name__ == 'easydiffraction.analysis.minimizers.bumps_amoeba'
...
def test_is_subclass_of_bumps():
    ...
    assert issubclass(BumpsAmoebaMinimizer, BumpsMinimizer)


def test_default_method():
    from easydiffraction.analysis.minimizers.bumps_amoeba import BumpsAmoebaMinimizer

    m = BumpsAmoebaMinimizer()
    assert m.method == 'amoeba'
...
def test_default_name():
    ...
    m = BumpsAmoebaMinimizer()
    assert m.name == MinimizerTypeEnum.BUMPS_AMOEBA
