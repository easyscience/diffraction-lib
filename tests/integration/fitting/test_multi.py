...
def test_single_fit_neutron_pd_tof_mcstas_lbco_si() -> None:
    ...
    model_1.space_group.coord_system_code = '1'
    ...
    model_2.space_group.coord_system_code = '2'
    ...
    # Set experiment
    data_path = download_data('meas-lbco-si-mcstas', destination=TEMP_DIR)
    ...
    expt.instrument.calib_d_to_tof_quadratic = -0.00001
    ...
    for x in range(45000, 115000, 5000):
        expt.background.create(id=str(x), position=x, intensity=0.2)
...
def _test_joint_fit_bragg_pdf_neutron_pd_tof_si() -> None:
    ...
    bragg_data_path = download_data('meas-si-sepd', destination=TEMP_DIR)
