...
def test_single_fit_pdf_xray_pd_cw_nacl() -> None:
    ...
    # Set experiment
    data_path = ed.download_data('measured/nacl-pdf', destination=TEMP_DIR)
...
def test_single_fit_pdf_neutron_pd_cw_ni():
    ...
    # Set experiment
    data_path = ed.download_data('measured/ni-pdf', destination=TEMP_DIR)
    project.experiments.add_from_data_path(
        name='pdf',
        data_path=data_path,
        sample_form='powder',
...
def test_single_fit_pdf_neutron_pd_tof_si():
    ...
    # Set experiment
    data_path = ed.download_data('measured/si-pdf-nomad', destination=TEMP_DIR)
    project.experiments.add_from_data_path(
        name='nomad',
        data_path=data_path,
        sample_form='powder',
