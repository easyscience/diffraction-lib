...
def test_joint_fit_split_dataset_neutron_pd_cwl_pbso4() -> None:
    ...
    expt1 = Experiment(name="npd1", data_path="examples/data/d1a_pbso4_first-half.dat")
    ...
    expt2 = Experiment(name="npd2", data_path="examples/data/d1a_pbso4_second-half.dat")
    ...
    project.analysis.joint_fit_experiments["npd1"].weight = 0.5  # Default
    project.analysis.joint_fit_experiments["npd2"].weight = 0.5  # Default
...
def test_basic_usage_joint_fit_neutron_xray_pd_cwl_pbso4() -> None:
    ...
    project = ed.Project(name='joint_fit')
    ...
    and X-ray diffraction data, both measured using constant wavelength.'''
    ...
    project.save_as(dir_path='pbso4_joint', temporary=True)
    ...
    # Show model names to be used for accessing the model
    # via project.sample_models['model_name']
    project.sample_models.show_names()

    # Modify sample model parameters via project object
    project.sample_models['pbso4'].space_group.name_h_m = 'P n m a'

    project.sample_models['pbso4'].cell.length_a = 8.5
    project.sample_models['pbso4'].cell.length_b = 5.35
    project.sample_models['pbso4'].cell.length_c = 6.9
    ...
    # Add X-ray diffraction experiment
    ...
    # Modify experimental parameters for the X-ray diffraction experiment
    ...
    # Add a line-segment background to the neutron diffraction experiment
    project.experiments['npd'].background_type = 'point'  # Attempt to set unknown type
    project.experiments['npd'].show_supported_background_types()
    project.experiments['npd'].show_current_background_type()
    # project.experiments['npd'].background_type = 'line-segment'  # Default type
    ...
    # Add a Chebyshev polynomial background to the X-ray diffraction experiment
    ...
    print(ed.section('Show experiments as CIF again; now the background is included'))
    project.experiments['npd'].show_as_cif()
    project.experiments['xrd'].show_as_cif()
    ...
    # project.analysis.fit_mode = 'single'  # Default mode
