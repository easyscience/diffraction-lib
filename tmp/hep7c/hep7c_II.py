...
data_path = 'data/HEP_7c_LaMe_riet.dat'
...
# %%
experiment = project.experiments['pd_xray_2']
...
# %%
project.plotter.plot_meas_vs_calc(expt_name='pd_xray_2', x_min=46.00, x_max=47.4)
