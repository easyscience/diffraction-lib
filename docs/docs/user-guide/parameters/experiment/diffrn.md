...
| Access                          | Source                     |
| ------------------------------- | -------------------------- |
| \_diffrn.ambient_electric_field | [EasyDiff][0]{:.label-cif} |
...
| Access                          | Source                     |
| ------------------------------- | -------------------------- |
| \_diffrn.ambient_magnetic_field | [EasyDiff][0]{:.label-cif} |
...
| Access                    | Source                     |
| ------------------------- | -------------------------- |
| \_diffrn.ambient_pressure | [EasyDiff][0]{:.label-cif} |
...
| Access                       | Source                     |
| ---------------------------- | -------------------------- |
| \_diffrn.ambient_temperature | [EasyDiff][0]{:.label-cif} |
