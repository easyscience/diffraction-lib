...
| Access           | Source                   |
| ---------------- | ------------------------ |
| \_data.two_theta | [EdSTAR][0]{:.label-cif} |
...
| Access                | Source                   |
| --------------------- | ------------------------ |
| \_data.time_of_flight | [EdSTAR][0]{:.label-cif} |
...
| Access           | Source                   |
| ---------------- | ------------------------ |
| \_data.d_spacing | [EdSTAR][0]{:.label-cif} |
...
| Access                | Source                   |
| --------------------- | ------------------------ |
| \_data.intensity_meas | [EdSTAR][0]{:.label-cif} |
...
| Access                   | Source                   |
| ------------------------ | ------------------------ |
| \_data.intensity_meas_su | [EdSTAR][0]{:.label-cif} |
...
| Access                | Source                   |
| --------------------- | ------------------------ |
| \_data.intensity_calc | [EdSTAR][0]{:.label-cif} |
...
| Access               | Source                   |
| -------------------- | ------------------------ |
| \_data.intensity_bkg | [EdSTAR][0]{:.label-cif} |
...
| Access             | Source                   |
| ------------------ | ------------------------ |
| \_data.calc_status | [EdSTAR][0]{:.label-cif} |
...
| Access          | Source                   |
| --------------- | ------------------------ |
| \_data.g_r_meas | [EdSTAR][0]{:.label-cif} |
...
| Access             | Source                   |
| ------------------ | ------------------------ |
| \_data.g_r_meas_su | [EdSTAR][0]{:.label-cif} |
...
| Access          | Source                   |
| --------------- | ------------------------ |
| \_data.g_r_calc | [EdSTAR][0]{:.label-cif} |
