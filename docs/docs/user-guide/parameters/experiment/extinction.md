...
Mosaicity distribution model (gauss or lorentz). Supported values include `gauss` and `lorentz`.
...
Active extinction type tag. Supported values include `becker-coppens`. This type is available for single-crystal experiments.
