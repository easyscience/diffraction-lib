...
=== "Keys in CIF"
    ...
    |  | :material-arrow-bottom-right: [exp_decay_beta_0](parameters/experiment/peak.md#peak-exp-decay-beta-0) | `_easydiffraction_peak.decay_beta_0` | [edifaCIF][0]{:.label-cif} |
    |  | :material-arrow-bottom-right: [exp_decay_beta_1](parameters/experiment/peak.md#peak-exp-decay-beta-1) | `_easydiffraction_peak.decay_beta_1` | [edifaCIF][0]{:.label-cif} |
    |  | :material-scale-unbalanced: [exp_rise_alpha_0](parameters/experiment/peak.md#peak-exp-rise-alpha-0) | `_easydiffraction_peak.rise_alpha_0` | [edifaCIF][0]{:.label-cif} |
    |  | :material-scale-unbalanced: [exp_rise_alpha_1](parameters/experiment/peak.md#peak-exp-rise-alpha-1) | `_easydiffraction_peak.rise_alpha_1` | [edifaCIF][0]{:.label-cif} |
