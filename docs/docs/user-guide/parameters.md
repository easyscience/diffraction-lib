...
=== "How to access in the code"
    ...
    |  | :material-cursor-move: [adp_iso](parameters/atom_site.md#atom-site-adp-iso) | atom_sites['ID'].adp_iso |
    |  | :material-reflect-horizontal: [multiplicity](parameters/atom_site.md#atom-site-multiplicity) | atom_sites['ID'].multiplicity |
    |  | :material-reflect-horizontal: [wyckoff_letter](parameters/atom_site.md#atom-site-wyckoff-letter) | atom_sites['ID'].wyckoff_letter |
...
=== "Keys in EdSTAR"
    ...
    |  | :material-cursor-move: [adp_iso](parameters/atom_site.md#atom-site-adp-iso) | `_atom_site.adp_iso` |
    |  | :material-reflect-horizontal: [multiplicity](parameters/atom_site.md#atom-site-multiplicity) | `_atom_site.multiplicity` |
    |  | :material-reflect-horizontal: [wyckoff_letter](parameters/atom_site.md#atom-site-wyckoff-letter) | `_atom_site.wyckoff_letter` |
...
=== "Keys in CIF"
    ...
    |  | :material-cursor-move: [adp_iso](parameters/atom_site.md#atom-site-adp-iso) | `_atom_site.B_iso_or_equiv` | [coreCIF][1]{:.label-cif} |
    |  | :material-reflect-horizontal: [multiplicity](parameters/atom_site.md#atom-site-multiplicity) | `_atom_site.site_symmetry_multiplicity` | [coreCIF][1]{:.label-cif} |
    |  | :material-reflect-horizontal: [wyckoff_letter](parameters/atom_site.md#atom-site-wyckoff-letter) | `_atom_site.Wyckoff_symbol` | [coreCIF][1]{:.label-cif} |
...
=== "Keys in CIF"
    ...
    | Category | Parameter | Key in CIF | CIF dictionary |
    | --- | --- | --- | --- |
    | :material-flask: [experiment_type][experiment_type] | :material-sawtooth-wave: [beam_mode](parameters/experiment_type.md#experiment-type-beam-mode) | `_easydiffraction_experiment_type.beam_mode` | [easydiffractionCIF][0]{:.label-cif} |
    |  | :material-radiology-box-outline: [radiation_probe](parameters/experiment_type.md#experiment-type-radiation-probe) | `_easydiffraction_experiment_type.radiation_probe` | [easydiffractionCIF][0]{:.label-cif} |
    |  | :material-diamond-stone: [sample_form](parameters/experiment_type.md#experiment-type-sample-form) | `_easydiffraction_experiment_type.sample_form` | [easydiffractionCIF][0]{:.label-cif} |
    |  | :material-chart-bell-curve: [scattering_type](parameters/experiment_type.md#experiment-type-scattering-type) | `_easydiffraction_experiment_type.scattering_type` | [easydiffractionCIF][0]{:.label-cif} |
...
=== "How to access in the code"
    ...
    |  | :material-format-superscript: [order](parameters/background.md#background-order) | background.order |
    |  | :material-arrow-collapse-up: [coef](parameters/background.md#background-coef) | background.coef |
...
=== "Keys in EdSTAR"
    ...
    |  | :material-format-superscript: [order](parameters/background.md#background-order) | `_background.order` |
    |  | :material-arrow-collapse-up: [coef](parameters/background.md#background-coef) | `_background.coef` |
...
=== "Keys in CIF"
    ...
    |  | :material-format-superscript: [order](parameters/background.md#background-order) | `_pd_background.Chebyshev_order` | [pdCIF][2]{:.label-cif} |
    |  | :material-arrow-collapse-up: [coef](parameters/background.md#background-coef) | `_pd_background.Chebyshev_coef` | [pdCIF][2]{:.label-cif} |
    ...
    |  | :material-shuffle-variant: [march_random_fract](parameters/preferred_orientation.md#preferred-orientation-march-random-fract) | `_easydiffraction_pref_orient.march_random_fract` | [easydiffractionCIF][0]{:.label-cif} |
...
=== "Keys in CIF"
    ...
    | Category | Parameter | Key in CIF | CIF dictionary |
    | --- | --- | --- | --- |
    | :material-microscope: [instrument][instrument] | :material-wrench: [setup_wavelength](parameters/instrument.md#instrument-setup-wavelength) | `_diffrn_radiation_wavelength.value` | [coreCIF][1]{:.label-cif} |
    |  | :material-tune: [calib_twotheta_offset](parameters/instrument.md#instrument-calib-twotheta-offset) | `_pd_calib.2theta_offset` | [pdCIF][2]{:.label-cif} |
    | :material-shape: [peak][peak] | :material-arrow-expand-horizontal: [broad_gauss_u](parameters/peak.md#peak-broad-gauss-u) | `_easydiffraction_peak.broad_gauss_u` | [easydiffractionCIF][0]{:.label-cif} |
    |  | :material-arrow-expand-horizontal: [broad_gauss_v](parameters/peak.md#peak-broad-gauss-v) | `_easydiffraction_peak.broad_gauss_v` | [easydiffractionCIF][0]{:.label-cif} |
    |  | :material-arrow-expand-horizontal: [broad_gauss_w](parameters/peak.md#peak-broad-gauss-w) | `_easydiffraction_peak.broad_gauss_w` | [easydiffractionCIF][0]{:.label-cif} |
    |  | :material-arrow-expand-horizontal: [broad_lorentz_x](parameters/peak.md#peak-broad-lorentz-x) | `_easydiffraction_peak.broad_lorentz_x` | [easydiffractionCIF][0]{:.label-cif} |
    |  | :material-arrow-expand-horizontal: [broad_lorentz_y](parameters/peak.md#peak-broad-lorentz-y) | `_easydiffraction_peak.broad_lorentz_y` | [easydiffractionCIF][0]{:.label-cif} |
...
=== "How to access in the code"
    ...
    | :material-shape: [peak][peak] | :material-arrow-expand-horizontal: [broad_gauss_sigma_0](parameters/peak.md#peak-broad-gauss-sigma-0) | peak.broad_gauss_sigma_0 |
    |  | :material-arrow-expand-horizontal: [broad_gauss_sigma_1](parameters/peak.md#peak-broad-gauss-sigma-1) | peak.broad_gauss_sigma_1 |
    |  | :material-arrow-expand-horizontal: [broad_gauss_sigma_2](parameters/peak.md#peak-broad-gauss-sigma-2) | peak.broad_gauss_sigma_2 |
    |  | :material-arrow-expand-horizontal: [broad_lorentz_gamma_0](parameters/peak.md#peak-broad-lorentz-gamma-0) | peak.broad_lorentz_gamma_0 |
    |  | :material-arrow-expand-horizontal: [broad_lorentz_gamma_1](parameters/peak.md#peak-broad-lorentz-gamma-1) | peak.broad_lorentz_gamma_1 |
    |  | :material-arrow-expand-horizontal: [broad_lorentz_gamma_2](parameters/peak.md#peak-broad-lorentz-gamma-2) | peak.broad_lorentz_gamma_2 |
    |  | :material-arrow-bottom-right: [exp_decay_beta_0](parameters/peak.md#peak-exp-decay-beta-0) | peak.exp_decay_beta_0 |
    |  | :material-arrow-bottom-right: [exp_decay_beta_1](parameters/peak.md#peak-exp-decay-beta-1) | peak.exp_decay_beta_1 |
    |  | :material-scale-unbalanced: [exp_rise_alpha_0](parameters/peak.md#peak-exp-rise-alpha-0) | peak.exp_rise_alpha_0 |
    |  | :material-scale-unbalanced: [exp_rise_alpha_1](parameters/peak.md#peak-exp-rise-alpha-1) | peak.exp_rise_alpha_1 |
...
=== "Keys in EdSTAR"
    ...
    | :material-shape: [peak][peak] | :material-arrow-expand-horizontal: [broad_gauss_sigma_0](parameters/peak.md#peak-broad-gauss-sigma-0) | `_peak.broad_gauss_sigma_0` |
    |  | :material-arrow-expand-horizontal: [broad_gauss_sigma_1](parameters/peak.md#peak-broad-gauss-sigma-1) | `_peak.broad_gauss_sigma_1` |
    |  | :material-arrow-expand-horizontal: [broad_gauss_sigma_2](parameters/peak.md#peak-broad-gauss-sigma-2) | `_peak.broad_gauss_sigma_2` |
    |  | :material-arrow-expand-horizontal: [broad_lorentz_gamma_0](parameters/peak.md#peak-broad-lorentz-gamma-0) | `_peak.broad_lorentz_gamma_0` |
    |  | :material-arrow-expand-horizontal: [broad_lorentz_gamma_1](parameters/peak.md#peak-broad-lorentz-gamma-1) | `_peak.broad_lorentz_gamma_1` |
    |  | :material-arrow-expand-horizontal: [broad_lorentz_gamma_2](parameters/peak.md#peak-broad-lorentz-gamma-2) | `_peak.broad_lorentz_gamma_2` |
    |  | :material-arrow-bottom-right: [exp_decay_beta_0](parameters/peak.md#peak-exp-decay-beta-0) | `_peak.exp_decay_beta_0` |
    |  | :material-arrow-bottom-right: [exp_decay_beta_1](parameters/peak.md#peak-exp-decay-beta-1) | `_peak.exp_decay_beta_1` |
    |  | :material-scale-unbalanced: [exp_rise_alpha_0](parameters/peak.md#peak-exp-rise-alpha-0) | `_peak.exp_rise_alpha_0` |
    |  | :material-scale-unbalanced: [exp_rise_alpha_1](parameters/peak.md#peak-exp-rise-alpha-1) | `_peak.exp_rise_alpha_1` |
...
=== "Keys in CIF"
    ...
    | :material-shape: [peak][peak] | :material-arrow-expand-horizontal: [broad_gauss_sigma_0](parameters/peak.md#peak-broad-gauss-sigma-0) | `_easydiffraction_peak.gauss_sigma_0` | [easydiffractionCIF][0]{:.label-cif} |
    |  | :material-arrow-expand-horizontal: [broad_gauss_sigma_1](parameters/peak.md#peak-broad-gauss-sigma-1) | `_easydiffraction_peak.gauss_sigma_1` | [easydiffractionCIF][0]{:.label-cif} |
    |  | :material-arrow-expand-horizontal: [broad_gauss_sigma_2](parameters/peak.md#peak-broad-gauss-sigma-2) | `_easydiffraction_peak.gauss_sigma_2` | [easydiffractionCIF][0]{:.label-cif} |
    |  | :material-arrow-expand-horizontal: [broad_lorentz_gamma_0](parameters/peak.md#peak-broad-lorentz-gamma-0) | `_easydiffraction_peak.lorentz_gamma_0` | [easydiffractionCIF][0]{:.label-cif} |
    |  | :material-arrow-expand-horizontal: [broad_lorentz_gamma_1](parameters/peak.md#peak-broad-lorentz-gamma-1) | `_easydiffraction_peak.lorentz_gamma_1` | [easydiffractionCIF][0]{:.label-cif} |
    |  | :material-arrow-expand-horizontal: [broad_lorentz_gamma_2](parameters/peak.md#peak-broad-lorentz-gamma-2) | `_easydiffraction_peak.lorentz_gamma_2` | [easydiffractionCIF][0]{:.label-cif} |
    |  | :material-arrow-bottom-right: [exp_decay_beta_0](parameters/peak.md#peak-exp-decay-beta-0) | `_easydiffraction_peak.decay_beta_0` | [easydiffractionCIF][0]{:.label-cif} |
    |  | :material-arrow-bottom-right: [exp_decay_beta_1](parameters/peak.md#peak-exp-decay-beta-1) | `_easydiffraction_peak.decay_beta_1` | [easydiffractionCIF][0]{:.label-cif} |
    |  | :material-scale-unbalanced: [exp_rise_alpha_0](parameters/peak.md#peak-exp-rise-alpha-0) | `_easydiffraction_peak.rise_alpha_0` | [easydiffractionCIF][0]{:.label-cif} |
    |  | :material-scale-unbalanced: [exp_rise_alpha_1](parameters/peak.md#peak-exp-rise-alpha-1) | `_easydiffraction_peak.rise_alpha_1` | [easydiffractionCIF][0]{:.label-cif} |
...
=== "Keys in CIF"
    ...
    | Category | Parameter | Key in CIF | CIF dictionary |
    | --- | --- | --- | --- |
    | :material-shape: [peak][peak] | :material-content-cut: [cutoff_q](parameters/peak.md#peak-cutoff-q) | `_easydiffraction_peak.cutoff_q` | [easydiffractionCIF][0]{:.label-cif} |
    |  | :material-arrow-expand-horizontal: [broad_q](parameters/peak.md#peak-broad-q) | `_easydiffraction_peak.broad_q` | [easydiffractionCIF][0]{:.label-cif} |
    |  | :material-knife: [sharp_delta_1](parameters/peak.md#peak-sharp-delta-1) | `_easydiffraction_peak.sharp_delta_1` | [easydiffractionCIF][0]{:.label-cif} |
    |  | :material-knife: [sharp_delta_2](parameters/peak.md#peak-sharp-delta-2) | `_easydiffraction_peak.sharp_delta_2` | [easydiffractionCIF][0]{:.label-cif} |
    |  | :material-arrow-bottom-right: [damp_q](parameters/peak.md#peak-damp-q) | `_easydiffraction_peak.damp_q` | [easydiffractionCIF][0]{:.label-cif} |
    |  | :material-arrow-bottom-right: [damp_particle_diameter](parameters/peak.md#peak-damp-particle-diameter) | `_easydiffraction_peak.damp_particle_diameter` | [easydiffractionCIF][0]{:.label-cif} |
