...
LaB₆ verification reference (`pd-neut-cwl_lab6`) was refined in FullProf
with `μR = 0.7`; the unmodelled correction is the _entire_ intensity
residual on the companion `pd-neut-cwl_lab6_absorption` page (≈5%
profile difference), while the `μR = 0` page passes to corr 0.9999.
