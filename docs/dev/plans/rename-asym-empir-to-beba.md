...
- [ ] **P1.8 — Update remaining docs and issue 133.** Update
  ...
  "add physical FCJ model" item open). Add a cross-reference to issue 166
  from the affected pages/issue where natural.
  Commit: `Update docs and issue 133 for beba asymmetry rename`
