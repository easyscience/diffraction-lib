...
project_2.experiments['sim_lbco'].peak.broad_gauss_sigma_0 = \
    project_1.experiments['sim_si'].peak.broad_gauss_sigma_0.value
project_2.experiments['sim_lbco'].peak.broad_gauss_sigma_1 = \
    project_1.experiments['sim_si'].peak.broad_gauss_sigma_1.value
project_2.experiments['sim_lbco'].peak.broad_gauss_sigma_2 = \
    project_1.experiments['sim_si'].peak.broad_gauss_sigma_2.value
project_2.experiments['sim_lbco'].peak.broad_mix_beta_0 = \
    project_1.experiments['sim_si'].peak.broad_mix_beta_0.value
project_2.experiments['sim_lbco'].peak.broad_mix_beta_1 = \
    project_1.experiments['sim_si'].peak.broad_mix_beta_1.value
project_2.experiments['sim_lbco'].peak.asym_alpha_0 = \
    project_1.experiments['sim_si'].peak.asym_alpha_0.value
project_2.experiments['sim_lbco'].peak.asym_alpha_1 = \
    project_1.experiments['sim_si'].peak.asym_alpha_1.value
