# Vendored HTML Asset Licenses

This file records the third-party licensing for vendored HTML assets in
this directory. The repository-level index is `THIRD_PARTY_LICENSES.md`.

## MathJax tex-mml-chtml Bundle
