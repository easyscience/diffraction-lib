...
class ProjectInfo:
    ...
    def __init__(self) -> None:
        self._name: str = "untitled_project"  # Short unique project identifier
...
class Project:
    ...
    def __init__(self, name: str = "untitled_project", title: str = "Untitled Project", description: str = "") -> None:
