...
class CifHandler:
    ...
    def project_name(self) -> str:
        """Edifa project data name used by project persistence."""
    ...
    def category_name(self) -> str:
        """Project data category name derived from the Edifa tag."""
        return _split_data_name(self.project_name)[0]

    @property
    def category_entry_name(self) -> str:
        """Project data item name derived from the Edifa tag."""
